...
/*
        ...
        for (int j = 1; j <n ; j++) {
            ...
            if(count%2==0||j>2){
                if ((radio1(matrix[j][0],matrix[j][1],h,pilares[1][j]/2))||!(radio2(matrix[j][0],matrix[j][1],h,pilares[1][j]/2))){
                    puente=false;
                    pilares[2][j]=0;
                    break;
                }else{
                ...
                if ((radio(matrix[j][0],matrix[j][1],h,pilares[1][j]/2))||!(radio2(matrix[j][0],matrix[j][1],h,pilares[1][j]/2))){
                    puente=false;
                    pilares[2][j]=0;
                    break;
                }else{
